...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(359, 541)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.Result = QtWidgets.QTextEdit(self.centralwidget)
        self.Result.setGeometry(QtCore.QRect(30, 20, 311, 81))
        font = QtGui.QFont()
        ...
        self.pushButtonDot = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.press_it("."))
